...
def _retry_or_search(state: AgentState) -> dict:
    """Return the next-step signal for the grader based on iteration count."""
...
def grader_node(state: AgentState) -> dict:
    ...
    Returns:
        A dict with `search_required` and `retry_retrieval` flags.
    """
